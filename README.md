Public Health News - TreeMap visualization of Google News related to public health.
===========
Inspired by http://newsmap.jp, this app uses the Google News API to visualize public health related news according to relevance.
